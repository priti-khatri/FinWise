...
st.title("FinWise Demo — Glassmorphism + Dark Mode + Lottie")

col1, col2 = st.columns(2)
with col1:
    st.markdown('<div class="glass-card">', unsafe_allow_html=True)
    st.header("Financial Growth")
    display_lottie("https://assets10.lottiefiles.com/packages/lf20_tutvdkg0.json", height=200, key="lottie1")
...
with col2:
    ...
    display_lottie("https://assets2.lottiefiles.com/private_files/lf30_oqpbtola.json", height=200, key="lottie2")
    st.write("Plan and organize your expenses using AI-powered recommendations.")
    st.markdown('</div>', unsafe_allow_html=True)

st.write("This is your stylish, modern FinWise homepage. Use this structure for additional modules (chatbot, glossary, etc.) as well.")